-- Create CRD tokens and subscription system tables
...
-- Enhanced marketplace_transactions table
CREATE TABLE IF NOT EXISTS public.marketplace_transactions (
  ...
  transaction_type TEXT NOT NULL, -- 'direct_purchase', 'auction_win'
...
-- Enhanced creator_earnings table
CREATE TABLE IF NOT EXISTS public.creator_earnings (
  ...
  status TEXT NOT NULL DEFAULT 'pending', -- 'pending', 'paid', 'processing'
...
-- Enhanced marketplace_transactions and creator_earnings RLS
...
CREATE OR REPLACE FUNCTION public.calculate_platform_fee(amount NUMERIC, fee_percentage NUMERIC DEFAULT 2.5)
RETURNS NUMERIC
LANGUAGE plpgsql
IMMUTABLE
AS $$
