-- Insert sample CRD frames with proper UUIDs
INSERT INTO crd_frames (
  name, category, description, frame_config, 
  is_public, price_cents, rating_average, rating_count, download_count, tags
) VALUES 
-- Sports Category
('Baseball Classic', 'sports', 'Traditional baseball card with player stats and team colors', 
...
('Basketball Modern', 'sports', 'Dynamic basketball card with action-oriented layout',
...
-- Art Category  
('Watercolor Portrait', 'art', 'Artistic frame with watercolor effects and elegant typography',
...
('Abstract Geometric', 'art', 'Bold geometric patterns with modern art aesthetics',
...
-- Sci-Fi Category
('Cyberpunk Neon', 'sci-fi', 'Futuristic cyberpunk design with neon accents and digital effects',
...
-- Fantasy Category
('Medieval Scroll', 'fantasy', 'Ancient parchment design with medieval decorative elements',
...
-- Gaming Category  
('Retro Arcade', 'gaming', '8-bit inspired design with pixel art elements',
...
-- Retrowave Category
('Synthwave Grid', 'retrowave', 'Classic 80s synthwave aesthetic with neon grid effects',
...
-- Minimalist Category
('Clean Minimalist', 'minimalist', 'Pure white minimalist design for clean, professional cards',
...
-- Decades Category
('Disco 70s', 'decades', 'Groovy 70s disco era with bold colors and patterns',
