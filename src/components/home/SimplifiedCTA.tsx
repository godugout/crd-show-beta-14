  ...
  return (
    <div className='bg-gradient-to-br from-crd-darkest via-purple-900/20 to-blue-900/20 flex justify-center items-center py-32 px-5'>
      <div className='flex flex-col items-center text-center max-w-4xl'>
        ...
        {/* Main CTA Content */}
        <Typography as='h2' variant='h1' className='mb-6 max-w-3xl'>
          {user ? (
            <>
        ...
        <div className='flex gap-6 flex-wrap justify-center'>
          <Link to='/create'>
            <CRDButton variant='create' size='xl'>
              Create a CRD
            </CRDButton>
          </Link>
          {!user && (
            <Link to='/cards/create'>
              <CRDButton variant='secondary' size='xl'>
                Simple Card Creator
              </CRDButton>
            </Link>
          )}
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 text-left'>
          <div className='bg-crd-dark/50 p-6 rounded-xl border border-crd-mediumGray'>
            ...
            <Typography variant='body' className='text-crd-lightGray text-sm'>
              Professional lighting, holographic effects, and immersive viewing
              experiences
            </Typography>
          </div>
          <div className='bg-crd-dark/50 p-6 rounded-xl border border-crd-mediumGray'>
            ...
            <Typography variant='body' className='text-crd-lightGray text-sm'>
              High-resolution PNG/JPG and animated GIF exports for print and
              digital use
            </Typography>
          </div>
          <div className='bg-crd-dark/50 p-6 rounded-xl border border-crd-mediumGray'>
            ...
            <Typography variant='body' className='text-crd-lightGray text-sm'>
              Intuitive tools and templates to bring your creative vision to
              life
            </Typography>
          </div>
        </div>
