      ...
      <div className="max-w-7xl mx-auto px-4 py-8 flex-1">
        ...
        <div className="flex justify-between items-center mb-8 animate-fade-in">
          ...
          <button 
            ...
            disabled={isLoading}
            className="flex items-center gap-2 hover-scale px-3 py-1.5 rounded-lg font-medium transition-all duration-200"
            style={{
        ...
        <div className="bg-card border border-border rounded-lg animate-fade-in" style={{ animationDelay: '0.5s' }}>
          <div className="flex items-center justify-between p-6 border-b border-border">
            ...
            <button 
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg font-medium transition-all duration-200 hover-scale"
              style={{
